  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of shopping with Online Grocery Store - your one-stop solution for fresh and organic food products, fulfilling all your daily needs. Book your order now!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1542838132-92c53300491e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxncm9jZXJ5fGVufDB8fHx8MTY5NTE4NTA4NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of shopping with Online Grocery Store - your one-stop solution for fresh and organic food products, fulfilling all your daily needs. Book your order now!`}
            </Text>
            <Box
